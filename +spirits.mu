...
** Modified +spirit output (@desc on SSP) to not rely on broken +view code

** TODO: Need to rejigger all the layouts to use Byzantine Opal's layout functions
